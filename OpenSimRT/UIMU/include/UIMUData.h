...
struct  UIMUData {
    /**
     * Alternative representation of the UIMUData.
     */
    typedef std::vector<std::pair<double, SimTK::Vector>> UIMUPack;
    ...
    /**
     * Total size in bytes of the UIMUData object.
     */
    static constexpr int size() { return 18; }

    /**
     * Represent the sensor values from UIMUData as a SimTK::Vector.
     */
    ...
    /**
     * Represent UIMUData as a UIMUPack (a list of std::pairs, where each pair
     ...
     */
    UIMUPack getAsPack() const;

    /**
     * Assign values to an UIMUData object from a UIMUPack (a list of pairs of
     * SimTK::Vectors containing the timeStamps and measurements of each sensor
     * in a IMU).
     */
    void setFromPack(const UIMUPack& pack);
